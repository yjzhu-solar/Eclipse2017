...
def calc_profile(emiss_table,dens,temp,height,height_grid,dens_grid,iondens_grid,te_grid,tp_grid,
...
awsom_data_set = scipy.io.readsav(r'../../sav/AWSoM/syn_fit/box_run0030_run01_75_5th_chstates/box_run0030_run01_75_5th_chstates.sav',
verbose = False,python_dict=True)
...
m_Fe = 55.845*amu
rho_FeX = np.abs(awsom_data_set['w'][12,:,:,:])
n_FeX = rho_FeX/m_Fe
rho_FeXIV = awsom_data_set['w'][13,:,:,:]
n_FeXIV = rho_FeXIV/m_Fe
...
chianti_emiss_tbl = scipy.io.readsav("../../sav/AWSoM/chianti_table/AWSoM_UCoMP_emiss_4Rsun_emisscalc.sav",verbose=True,python_dict=True)
...
save_path = "../../sav/AWSoM/syn_fit/box_run0030_run01_75_5th_chstates/"
...
iondens_grids = [n_FeXIV, n_FeX]

filenames = ["FeXIV_530_synspec_emiss.h5", "FeX_637_synspec_emiss.h5"]


for ii, (emiss_array_, iondens_grid_, wvl_grid_, rest_wvl_, ion_amu_, int_max_init_, fwhm_init_, filename_) in \
    enumerate(zip(emiss_array_names, iondens_grids ,wvl_grids, rest_wvls, ion_amus, int_max_inits,
                fwhm_inits, filenames)):
    syn_profiles, emiss_box, veff_box = calc_profile(chianti_emiss_tbl[emiss_array_], chianti_emiss_tbl["dens"],
                        chianti_emiss_tbl["temp"],chianti_emiss_tbl["height"],height_grid, n,iondens_grid_ , t_e,
